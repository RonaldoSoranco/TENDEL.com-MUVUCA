...
import { EnvelopeIcon, LockClosedIcon, UserIcon, EyeIcon, EyeSlashIcon, SparklesIcon } from '@heroicons/react/24/outline'
      ...
      >
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10">
          ...
          >
            ...
            <p className="text-gray-500 mt-2">Junte-se à comunidade TENDEL.COM!</p>
          </motion.div>
